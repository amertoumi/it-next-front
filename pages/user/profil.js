...
import {API_HOST, API_LAST_FILE, API_UPDATE_PROFIL, API_UPLOAD_FILE} from '../../API';
                    ...
                    <Col>
                        ...
                        <div style={div_video}>
                            ...
                            <div style={div_btn_video}>
                                <label htmlFor="record-btn" style={custom_file_record}>Record video</label>
                                <input id="record-btn"
                                       type="button"
                                       style={{display: 'none'}}
                                       onClick={UploadVideo}/>
                                <label htmlFor="file-upload" style={custom_file_upload}>Upload a video</label>
                                <input id="file-upload"
                                       type="button"
                                       style={{display: 'none'}} onClick={UploadVideo}/>
                                <label htmlFor="delete_btn-upload" style={custom_file_delete}>Delete video</label>
                                <input id="delete_btn-upload" type="button" onClick={onClick}
                                       style={{display: 'none'}}/>
                            </div>
                        </div>
                        <div style={{marginTop: '2rem'}}>
                            <p>Dear inspirnaute, to start out, you can, if you wish record a video to explain in <b> 30
                                seconds </b>
                                your background, who you are, what you like and what you expect from your next mission.
                            </p>
                        </div>
                        <div>
                            <p>

...
/* function EditorHomePageFR() {
  ...
  const AddData = () => {
    var url = API_HOST + API_EDIT_HOMEPAGE_CONTENT_PATH + "EN";
    ...
    <div className="App">
      <div className="slogan_fr">
        ...
        <div>
          <CKEditor
            ...
            data={ENContent[0]?.sectionPresentation}
            onReady={(editor) => {}}
      ...
      <div className="Embaucher_fr">
        ...
        <div>
          <CKEditor
            editor={ClassicEditor}
            data={ENContent[0]?.sectionRecruiter}
            onReady={(editor) => {}}
            onChange={(event, editor) => {
              const data = editor.getData();
              setRecruiter(data);
      ...
      <div className="Bg-recruiter_fr">
        ...
        <div>
          <CKEditor
            editor={ClassicEditor}
            data={ENContent[0]?.sectionRecruiterBackground}
            onReady={(editor) => {}}
            onChange={(event, editor) => {
              const data = editor.getData();
      ...
      <div className=" embaucher_fr">
        ...
        <div>
          <CKEditor
            editor={ClassicEditor}
            data={ENContent[0]?.sectionClouds}
            onReady={(editor) => {}}
            onChange={(event, editor) => {
              const data = editor.getData();
              setClouds(data);
      ...
      <div className="mission1_fr">
        ...
        <div>
          <CKEditor
            editor={ClassicEditor}
            data={ENContent[0]?.sectionMission1}
            onReady={(editor) => {}}
            onChange={(event, editor) => {
              const data = editor.getData();
              setMission1(data);
      ...
      <div className="mission2_fr">
        ...
        <div>
          <CKEditor
            editor={ClassicEditor}
            data={ENContent[0]?.sectionMission2}
            onReady={(editor) => {}}
            onChange={(event, editor) => {
              const data = editor.getData();
              setMission2(data);
      ...
      <div className="Client _fr">
        ...
        <div>
          <CKEditor
            editor={ClassicEditor}
            data={ENContent[0]?.sectionClient}
            onReady={(editor) => {}}
            onChange={(event, editor) => {
              const data = editor.getData();
              setClient(data);
      ...
      <div className="Talents_fr">
        ...
        <div>
          <CKEditor
            editor={ClassicEditor}
            data={ENContent[0]?.sectionTalent}
            onReady={(editor) => {}}
            onChange={(event, editor) => {
              const data = editor.getData();
              setTalent(data);
      ...
      <div className="Inspiranute">
        ...
        <div>
          <CKEditor
            editor={ClassicEditor}
            data={ENContent[0]?.sectionInspirenaute}
            onReady={(editor) => {}}
            onChange={(event, editor) => {
              const data = editor.getData();
              setInspirnaute(data);
      ...
      <div className="Footer_fr">
        ...
        <div>
          <CKEditor
            editor={ClassicEditor}
            data={ENContent[0]?.sectionFooter}
            onReady={(editor) => {}}
            onChange={(event, editor) => {
              const data = editor.getData();
              setFooter(data);
